<template>
	<footer>
		<div class="w-full mx-auto">
			<div
				class="px-4 py-6 text-center bg-white dark:bg-slate-700 md:flex md:items-center md:justify-between"
			>
				<div class="space-y-3">
					<p class="text-sm sm:text-center text-slate-700 dark:text-white">
					...
					<p class="text-sm sm:text-start text-slate-700 dark:text-white">
						Desenvolvido por:
						<NuxtLink
							class="hover:underline"
							to="https://github.com/rafinhacuri"
							external
							target="_blank"
						>
							Rafael Curi
				...
				<div class="flex justify-center mt-4 space-x-5 md:mt-0 me-0 md:me-20">
					<UTooltip text="Instagram" :popper="{ placement: 'top' }">
						<NuxtLink
							to="https://www.instagram.com/cbpfoficial"
							external
							target="_blank"
							class="text-slate-700 dark:text-white hover:text-gray-900 dark:hover:text-white"
						>
							<svg
								class="w-4 h-4"
								fill="currentColor"
